...
Tests the complete flexible work time processing pipeline including:
- Phase 1: Punch validation and work block building
- Phase 2: Gap analysis and block attribution
- Overnight shift handling

Run: python -m tests.test_flexible_processing_integration
Or: python manage.py shell < tests/test_flexible_processing_integration.py
"""
